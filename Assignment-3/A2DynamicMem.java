        ...
        while(min_address!=null){
            ...
            if(temp!=null && temp.address==(min_address.address + min_address.size)){
                ...
                if(this.type==2){
                    ...
                    AVLTree temp_free = new AVLTree(a_temp,s_temp,s_temp);
                    AVLTree min_defrag = new AVLTree(a_min,s_min,a_min);
                    AVLTree temp_defrag = new AVLTree(a_temp,s_temp,a_temp);
                    freeBlk.Delete(min_free);
                    freeBlk.Delete(temp_free);
                    defrag.Delete(min_defrag);                
                    defrag.Delete(temp_defrag);                                
